...
base_pay_billing_view__query_order = {
    ...
    'parameters': [
        ...
        OpenApiParameter(name='pid', required=False, location=OpenApiParameter.QUERY, description='支付平台账单id',
                         type=OpenApiTypes.STR),
        OpenApiParameter(name='app_id', location=OpenApiParameter.QUERY,
                         description='应用id', type=OpenApiTypes.INT),
        OpenApiParameter(name='sign',
                         location=OpenApiParameter.QUERY, description='签名', type=OpenApiTypes.STR),
    ],
